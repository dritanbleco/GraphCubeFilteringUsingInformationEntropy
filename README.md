...
###### This repository provides sample code and datasets from the following publication:<br/> [1] **Bleco, D. , Kotidis, Y. _Using Entropy Metrics for Pruning Very Large Graph Cubes_, submitted to "Information Systems" journal.**
------------
